...
<body bgcolor="cyan">
	<h1 align="center">
		<img src="C:\image\rays.png" width="250px" height="100px">
	</h1>
 ...
 %>
			...
			<tr>
				...
				<td><input type="submit" value="Submit"><a
					href="ForgotPasswordView.jsp">Forgot Password</a></td>
			<tr>
				<th></th>
				<td><a href="RegistrationForm.jsp"> Create New Account</a></td>
			</tr>
