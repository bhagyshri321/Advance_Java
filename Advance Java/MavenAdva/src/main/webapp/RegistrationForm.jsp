...
<body bgcolor="teal">
 ...
 %>
			...
			<tr>
				<th>Contact</th>
				<td><input type="number" id="quantity" name="contact"></td>
			...
			<tr>
				<th>PWD</th>
				<td><input type="number" id="quantity" name="pwd"></td>
			...
			<tr>
				...
				<td><input type="submit" value="Register"><a
					href="LogInView.jsp"> <input type="button"
						value="All Ready Registered"></a></td>
			</tr>
		</table>
